...
CREATE ROLE barman;
ALTER ROLE barman WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md530a5905ad3094164f2d7c9de500e69a5';
CREATE ROLE belv1601;
ALTER ROLE belv1601 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5477a27ad66a9170bac0c9e4eaff4ff5b';
CREATE ROLE bres;
ALTER ROLE bres WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5b9e9c3444e8a2990bc100eabbd329653';
CREATE ROLE cabw2601;
ALTER ROLE cabw2601 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md56f1e1a9895be5ec584869984ccd9b4cf';
CREATE ROLE camv2202;
ALTER ROLE camv2202 WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5a11cd9c0f8a2bbb51a3d9a672224a219';
CREATE ROLE coleo;
ALTER ROLE coleo WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5792fd5b151d38a214e0b26d063aafc50';
CREATE ROLE coleo_remote;
ALTER ROLE coleo_remote WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5e53e6e9003345dd4688dcb40719c1436';
CREATE ROLE coleo_test_user;
ALTER ROLE coleo_test_user WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md51f3dc139e3237b9ca47f48648c7bc2f1';
CREATE ROLE dubr1504;
ALTER ROLE dubr1504 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5cdd3097569097f04b25cfafc3130e99e';
CREATE ROLE glaroc;
ALTER ROLE glaroc WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md54fae8551a0173b90e07d0c1dc3ceac18';
CREATE ROLE merb2202;
ALTER ROLE merb2202 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5d90ffa08138eddaad980367113202978';
...
ALTER ROLE strapidbuser WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md58265111991087ae647fe73711edb98d6';
CREATE ROLE sviss;
...
CREATE ROLE vbeaure;
ALTER ROLE vbeaure WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5269beaa5c465ced6f41106b6ddad41e1';
CREATE ROLE will;
ALTER ROLE will WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5dfec2ae2b9c24a66076e49ee23e70a74';
--
-- User Configurations
--
...
CREATE TABLE public.observations (
    ...
    id_taxa_obs integer,
    within_quebec boolean NOT NULL,
