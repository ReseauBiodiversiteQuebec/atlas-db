...
REVOKE ALL ON schema raw_data FROM read_write_all_staging;
...
GRANT USAGE, CREATE ON SCHEMA public TO read_write_all_staging;
GRANT USAGE, CREATE ON SCHEMA public_api TO read_write_all_staging;
GRANT USAGE, CREATE ON SCHEMA api TO read_write_all_staging;
GRANT USAGE, CREATE ON SCHEMA raw_data TO read_write_all_staging;
...
GRANT SELECT,INSERT, UPDATE, TRUNCATE, REFERENCES,TRIGGER ON ALL TABLES IN SCHEMA raw_data TO read_write_all_staging;
