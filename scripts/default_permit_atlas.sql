...
ALTER DEFAULT PRIVILEGES IN SCHEMA public REVOKE ALL ON TABLES FROM PUBLIC; -- this one is important since new roles inherit privilegies from public so it is safety to remove all privilegies from PUBLIC before anything--
